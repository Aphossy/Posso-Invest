...
const filterInputVariants = cva(
  [
    "flex items-center gap-2 outline-none transition w-full  px-3 focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
  ],
  {
    variants: {
      variant: {
