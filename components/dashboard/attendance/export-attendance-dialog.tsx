...
import {
  exportAttendance,
  type AttendanceExportable,
  type ExportOptions,
} from "@/utils/attendance-export-utils"
...
interface ExportAttendanceDialogProps {
  ...
  selectedAttendance?: AttendanceExportable[]
}

const exportFields = [
  { id: "meetingTitle", label: "Meeting", default: true },
  { id: "memberName", label: "Member", default: true },
  { id: "memberEmail", label: "Member Email", default: false },
  { id: "status", label: "Status", default: true },
  { id: "checkedInAt", label: "Checked In", default: true },
  ...
  const handleExport = async () => {
    ...
    const exportPromise = new Promise<void>((resolve, reject) => {
      try {
        ...
        exportAttendance(dataToExport, options)
        resolve()
      } catch (error) {
        reject(error)
      }
    ...
    toast.promise(exportPromise, {
      loading: `Exporting ${exportCount} records as ${format.toUpperCase()}...`,
      success: `Successfully exported ${exportCount} records as ${format.toUpperCase()}`,
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={`attendance-export-${new Date().toISOString().split("T")[0]}`}
            />
          </div>
