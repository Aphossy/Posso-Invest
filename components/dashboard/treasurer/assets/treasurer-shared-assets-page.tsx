...
// Treasurer sees public + authenticated + committee (no admin-only)
...
export default function TreasurerSharedAssetsPage() {
    ...
    <div className="container mx-auto space-y-8 py-0 sm:py-5">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Filter by visibility. Private files and admin-only assets are not
            shown.
          </CardDescription>
        </CardHeader>
          ...
          {isLoading || profileLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="mb-6 max-w-sm text-muted-foreground">
                Upload a file with Public, All Members, or Committee Only
                visibility to have it appear here.
              </p>
              <Button onClick={() => setUploadOpen(true)}>
                <Upload className="mr-2 h-4 w-4" />
                Upload Asset
