...
export function TreasurerPenaltiesView() {
    ...
    await updateMutation.mutateAsync(
      {
        id: waiverTarget.id,
        status: "waived",
        waivedReason: waiverReason.trim() || "Waived by treasurer",
      },
      {
        onSuccess: () => {
    ...
    <div className="flex items-center gap-3 border-b border-amber-200 bg-amber-50 px-6 py-4 dark:border-amber-800 dark:bg-amber-950/30">
      ...
      <div>
        ...
        <p className="mt-0.5 text-xs text-amber-700/80 dark:text-amber-400/80">
          Requires your authorisation as treasurer.
        </p>
      </div>
    </div>
  ) : null
    ...
    <div className="space-y-5 px-6 py-5">
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          id="wr-reason"
          rows={3}
          placeholder="e.g. Grace period approved by president at the meeting"
          value={waiverReason}
      ...
      <label className="flex cursor-pointer select-none items-start gap-3">
        ...
        <span className="text-xs leading-relaxed text-muted-foreground">
          I confirm this waiver has been approved and I am authorised to record
          it.
        </span>
      </label>
    </div>
    ...
    <div className="flex-1 space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">
            Issue, track, and manage late contribution penalties across all
            members.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          value={<span className="text-rose-600">{formatRwf(totalOwed)}</span>}
      ...
      <ResponsiveOverlay
        ...
        title="Waive Penalty"
        description="Requires your authorisation as treasurer."
        desktopWidthClassName="sm:max-w-md"
        header={waiverHeader}
        footer={waiverFooter}>
        {waiverBody}
