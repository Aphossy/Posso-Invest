...
export function EditAssetDialog({
  ...
  const [visibility, setVisibility] = useState<
    "private" | "committee" | "authenticated"
  >("private")
  ...
  useEffect(() => {
    ...
    setVisibility(
      (asset.visibility as "private" | "committee" | "authenticated") ||
        "private"
    )
    setAlt(asset.alt || "")
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <Select
            value={visibility}
            onValueChange={(value) =>
              setVisibility(value as "private" | "committee" | "authenticated")
            }>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          placeholder="loan, receipt, 2025 (comma-separated)"
        />
      </div>
