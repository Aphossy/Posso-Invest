...
CREATE TYPE "public"."message_service" AS ENUM('contributions-savings', 'loans-repayments', 'meetings-minutes', 'penalties-compliance', 'member-account', 'access-technical', 'other');--> statement-breakpoint
