...
export default function DashboardError({
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-linear-to-br from-white via-blue-50/30 to-white dark:from-gray-950 dark:via-blue-950/20 dark:to-gray-950">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#165598]/10 rounded-full blur-3xl animate-pulse" />
        <div
      ...
      <motion.div
        className="pointer-events-none absolute h-96 w-96 rounded-full bg-[#165598]/5 blur-3xl"
        animate={{
          x: mousePosition.x * 3,
          y: mousePosition.y * 3,
        }}
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
        ...
        <motion.div
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute inset-0 h-24 w-24 rounded-full border-2 border-[#165598]/20"
            />
            <motion.div
              animate={{ rotate: -360 }}
              transition={{
              ...
              className="absolute inset-2 h-20 w-20 rounded-full border border-[#28bcd6]/30"
            />

            {/* Central icon */}
            <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-[#165598]/10 to-[#28bcd6]/10 backdrop-blur-sm border border-[#165598]/20">
              <LayoutDashboard className="h-12 w-12 text-[#165598]" />
        ...
        {process.env.NODE_ENV === "development" && error.message && (
          <motion.div
            ...
            className="mx-auto mb-8 max-w-2xl rounded-lg border border-[#165598]/30 bg-[#165598]/5 p-4 text-left">
      ...
      <div className="absolute top-20 right-20 hidden xl:block">
        <motion.div
          ...
          <Settings className="h-8 w-8 text-[#165598]/20" />
        </motion.div>
      </div>
