...
interface LoanUpdatedLeadershipEmailProps {
...
export function LoanUpdatedLeadershipEmail({
  recipientName,
  memberName,
  memberEmail,
  oldStatus,
  ...
  updatedByName,
  loanId,
}: LoanUpdatedLeadershipEmailProps) {
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>
        Loan updated for {memberName}: {oldStatus} to {newStatus}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Text style={brand}>{organisationName}</Text>
            <Text style={subtitle}>Loan Oversight Update</Text>
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Treasurer {updatedByName} updated a loan record. Details are
              provided below for oversight.
            </Text>
            ...
            <Section style={buttonSection}>
              <Button href={`${baseUrl}/admin/financial/loans`} style={button}>
                Open Loans
              </Button>
            </Section>
...
LoanUpdatedLeadershipEmail.PreviewProps = {
...
} satisfies LoanUpdatedLeadershipEmailProps
