...
interface ActionItemCreatedLeadershipEmailProps {
...
export function ActionItemCreatedLeadershipEmail({
  recipientName,
  title,
  description,
  priority,
  ...
  createdByName,
  actionItemId,
}: ActionItemCreatedLeadershipEmailProps) {
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>
        Secretary {createdByName} created a new action item: {title}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading style={heading}>New action item created</Heading>
            <Text style={paragraph}>Muraho {recipientName},</Text>
            <Text style={paragraph}>
              Secretary {createdByName} created a new action item. Details are
              below for leadership visibility.
            </Text>
...
ActionItemCreatedLeadershipEmail.PreviewProps = {
...
} satisfies ActionItemCreatedLeadershipEmailProps
