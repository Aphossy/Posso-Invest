...
interface PenaltyRecordedNotificationEmailProps {
...
export function PenaltyRecordedNotificationEmail({
  recipientName,
  memberName,
  memberEmail,
  amount,
  ...
  penaltyId,
  issuedByName,
}: PenaltyRecordedNotificationEmailProps) {
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>
        Treasurer {issuedByName} recorded a penalty for {memberName}.
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Text style={brand}>{organisationName}</Text>
            <Text style={subtitle}>Penalty Oversight Alert</Text>
          </Section>

          <Section style={content}>
            <Heading style={heading}>New penalty recorded</Heading>
            <Text style={paragraph}>Muraho {recipientName},</Text>
            <Text style={paragraph}>
              Treasurer {issuedByName} recorded a penalty that requires
            ...
            <Section style={buttonSection}>
              <Button
                href={`${baseUrl}/admin/financial/penalties`}
                style={button}>
                Open Penalties
              </Button>
            </Section>
...
PenaltyRecordedNotificationEmail.PreviewProps = {
  recipientName: "Admin User",
  memberName: "Theogene Iradukunda",
  memberEmail: "theogene@example.com",
  amount: "5,000",
  currency: "RWF",
  period: "2026-03",
...
} satisfies PenaltyRecordedNotificationEmailProps
