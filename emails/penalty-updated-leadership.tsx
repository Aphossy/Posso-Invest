...
interface PenaltyUpdatedLeadershipEmailProps {
...
export function PenaltyUpdatedLeadershipEmail({
  recipientName,
  memberName,
  memberEmail,
  oldStatus,
  ...
  updatedByName,
  penaltyId,
}: PenaltyUpdatedLeadershipEmailProps) {
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>
        Treasurer {updatedByName} updated a penalty for {memberName}.
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Text style={brand}>{organisationName}</Text>
            <Text style={subtitle}>Penalty Oversight Update</Text>
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Treasurer {updatedByName} updated a penalty. Details are below for
...
PenaltyUpdatedLeadershipEmail.PreviewProps = {
...
} satisfies PenaltyUpdatedLeadershipEmailProps
