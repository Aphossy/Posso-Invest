...
interface ActionItemStatusChangedOwnerEmailProps {
...
export function ActionItemStatusChangedOwnerEmail({
  recipientName,
  title,
  oldStatus,
  newStatus,
  ...
  changedByName,
  actionItemId,
}: ActionItemStatusChangedOwnerEmailProps) {
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>
        Status updated for action item "{title}": {oldStatus} to {newStatus}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Text style={brand}>{organisationName}</Text>
            <Text style={subtitle}>Action Item Status Update</Text>
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              {changedByName} updated the status of your action item.
            </Text>
...
ActionItemStatusChangedOwnerEmail.PreviewProps = {
  ...
  changedByName: "Theogene Iradukunda",
  actionItemId: "act_01JABCDEF",
} satisfies ActionItemStatusChangedOwnerEmailProps
