    ...
    items: [
      {
        ...
        url: "/member/planned-activities",
        icon: Calendar,
        description: "Upcoming activities scheduled by the secretary",
        shortcut: "mod+5",
      },
      {
...
export const TREASURER_NAVIGATION: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      {
        title: "Planned Activities",
        url: "/treasurer/planned-activities",
        icon: Calendar,
        description: "Upcoming activities scheduled by the secretary",
        shortcut: "mod+a",
        isNew: false,
...
export const SECRETARY_NAVIGATION: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      {
        title: "Planned Activities",
        url: "/secretary/planned-activities",
        icon: Calendar,
        description: "Create and share future activities",
        shortcut: "mod+3",
      },
    ],
  },
...
export const PRESIDENT_NAVIGATION: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      {
        title: "Planned Activities",
        url: "/president/planned-activities",
        icon: Calendar,
        description: "View upcoming activities scheduled by the secretary",
        shortcut: "mod+4",
      },
    ],
  },
    ...
    items: [
      {
        ...
        url: "/admin/dashboard",
        icon: LayoutDashboard,
        description: "10/10 Ventures overview",
        shortcut: "mod+1",
      },
      {
        title: "Group Health",
